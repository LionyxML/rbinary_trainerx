...
ent_answer = tk.Entry(root, justify = "center", font = ("TkFixedFont", 24), state = "readonly")
ent_answer.grid(row = 0, column = 0, columnspan = 8, pady = 20)

sca_bit7 = tk.Scale(root, orient = "vertical", from_ = 1, to = 0, showvalue = show_binary, command = calc)
sca_bit7.grid(row = 1, column = 0)

sca_bit6 = tk.Scale(root, orient = "vertical", from_ = 1, to = 0, showvalue = show_binary, command = calc)
sca_bit6.grid(row = 1, column = 1)

sca_bit5 = tk.Scale(root, orient = "vertical", from_ = 1, to = 0, showvalue = show_binary, command = calc)
sca_bit5.grid(row = 1, column = 2)

sca_bit4 = tk.Scale(root, orient = "vertical", from_ = 1, to = 0, showvalue = show_binary, command = calc)
sca_bit4.grid(row = 1, column = 3)

sca_bit3 = tk.Scale(root, orient = "vertical", from_ = 1, to = 0, showvalue = show_binary, command = calc)
sca_bit3.grid(row = 1, column = 4)

sca_bit2 = tk.Scale(root, orient = "vertical", from_ = 1, to = 0, showvalue = show_binary, command = calc)
sca_bit2.grid(row = 1, column = 5)

sca_bit1 = tk.Scale(root, orient = "vertical", from_ = 1, to = 0, showvalue = show_binary, command = calc)
